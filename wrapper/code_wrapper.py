...
java_commands = {
    Commands.FORWARD: "makePointX(%s)",
    Commands.BACKWARD: "makePointX(-%s)",
    Commands.TURN_LEFT: "makePointTurn(-%s * Math.PI / 180)",
    Commands.TURN_RIGHT: "makePointTurn(%s * Math.PI / 180)",
}
